...
class Structure(BaseModel):
    ...
    contributions: str = Field(description="describe the main contributions of this paper")
    ...
    related_work: str = Field(description="describe the most related work in this paper")