...
### [8] [SeqFeed: Improving Agentic RTL Code Generation with Sequential Behavior Feedback](https://arxiv.org/abs/2608.16934)
...
### [9] [DTX: A Throughput-First Training Accelerator for Diffusion and Transformer Models](https://arxiv.org/abs/2608.16953)
*Shashank*
...
### [10] [RENESIS: Energy-Aware Synthesis of Adiabatic Logic from Irreversible Netlists](https://arxiv.org/abs/2608.17139)
*Mitchell A. Thornton*
...
### [11] [The Road Less Traveled: Congestion-Aware NoC Placement and Packet Routing for FPGAs](https://arxiv.org/abs/2608.17266)
...
### [12] [NeuroAbs: A Neuro-Symbolic RTL Abstraction Framework for Property Checking Acceleration](https://arxiv.org/abs/2608.17304)
...
### [13] [ETHEREAL: A 25.6-$μ$s/inf. Low-latency Event-driven Graph-neural-network Processor for High-resolution Vision at the Edge](https://arxiv.org/abs/2608.17787)
...
### [14] [ESR-HGNN: Eliminating Semantic Redundancy for Efficient Mini-batch HGNN Inference](https://arxiv.org/abs/2608.17865)
...
### [15] [An O-RAN-Assisted MARL Approach for Dynamic Sidelink and Infrastructure Selection in V2X Communications](https://arxiv.org/abs/2608.17210)
...
### [16] [LoRIS: LoRaWAN-based IoT Platform for Sustainability Monitoring in Hotels](https://arxiv.org/abs/2608.17467)
...
### [17] [Predict Before Replay: Joint FEC and Flight Control for Reliable Scale-Up Links](https://arxiv.org/abs/2608.17503)
...
### [18] [Completion-Path Credits: Multi-Resource Control for Scale-Up Fabrics](https://arxiv.org/abs/2608.17523)
*Fan Yang,Jiaqi Liu,Tao Jiang,Zhan Wang*
...
### [19] [Array-Based Molecular Pulse Encoding for Neuro-Spike Communication in Intra-Body Nano-networks](https://arxiv.org/abs/2608.17675)
*Keyvan Aghababaiyan*
...
### [20] [Threat Aware Task Offloading and Caching for Secure UAV Assisted Vehicular Consumer Electronics](https://arxiv.org/abs/2608.17794)
