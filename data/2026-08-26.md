...
### [16] [PowerSlider: Exploiting Phase Asymmetry for LLM Serving under Demand Response](https://arxiv.org/abs/2608.21719)
...
### [17] [Rapid Earthquake-to-Tsunami Waveform Generation via Large-Scale Multi-GPU FFT Convolution Applied to the Cascadia Subduction Zone](https://arxiv.org/abs/2608.21763)
...
### [18] [A Concurrent Queue System for Multi-GPU Platforms: Application to Bellman-Ford SSSP](https://arxiv.org/abs/2608.21826)
*Beyza Cavusoglu*
...
### [19] [PRISM: Predictive Runtime In-place Scaling and Model Selection for Edge Microservices](https://arxiv.org/abs/2608.21910)
...
### [20] [Systematization of Knowledge: Formal Verification of Consensus Protocols](https://arxiv.org/abs/2608.21935)
...
### [21] [Scalable Exact Path Selection via Structure-Aware Search for Virtual Payment Channels](https://arxiv.org/abs/2608.22276)
...
### [22] [Non-Leaking Concurrent Objects](https://arxiv.org/abs/2608.22288)
...
### [23] [Understanding the Synchronization Tax in GPU Scale-Up Domains](https://arxiv.org/abs/2608.22503)
...
### [24] [Model-Consistent Byzantine-Resilient Decentralized Federated Learning for Collaborative Missions](https://arxiv.org/abs/2608.22552)
...
### [25] [NeuroPrefetcher: Storage-Aware Sparse LLM Inference via Delta Prefetching](https://arxiv.org/abs/2608.22643)
...
### [26] [Exploring spectral element methods on the Tenstorrent RISC-V accelerator](https://arxiv.org/abs/2608.22964)
...
### [27] [Introducing the Self-Stabilizing SLEEPING Model](https://arxiv.org/abs/2608.23044)
...
### [28] [Effects of Hybrid CPU and Cache Architectures on Parallel HPC and Cloud Applications](https://arxiv.org/abs/2608.23165)
...
### [29] [Programmable Compute-in-Transit using Integrated Photonics](https://arxiv.org/abs/2608.21536)
...
### [30] [Model Compression and Hardware-Aware Acceleration for Deep Learning on FPGAs: A Co-Design Taxonomy and Comparative Analysis](https://arxiv.org/abs/2608.21657)
...
### [31] [TherMapNet Attention-Guided Runtime Full-Chip Thermal Map Prediction from Performance Metrics](https://arxiv.org/abs/2608.21887)
...
### [32] [NoTB: Oracle-Free Triage of LLM-Generated RTL via Cross-Model Formal Consensus](https://arxiv.org/abs/2608.21962)
...
### [33] [Precision-Aware Variable Bit Processing Elements for Hardware-Efficient Systolic Array Designs](https://arxiv.org/abs/2608.22378)
...
### [34] [Architecting the Next Generation of Asynchronous, Distributed GPUs for the AI Era](https://arxiv.org/abs/2608.22602)
...
### [35] [NOVA: Technology-Architecture Co-Design of Near-Memory Processing for Attention-SSM-MoE Hybrid LLM Inference](https://arxiv.org/abs/2608.22613)
...
### [36] [A Process-Aware Hybrid Si/IGO Monolithic-3D 6T SRAM with BEOL Pass-Gates for the 2nm Node](https://arxiv.org/abs/2608.22741)
...
### [37] [SYNTLOG: FSM Benchmarks Evaluation for FPGA](https://arxiv.org/abs/2608.23288)
...
### [38] [VIPER: Architecture-Aware Performance Modeling for Processing-in-Memory Design-Space Exploration](https://arxiv.org/abs/2608.23404)
