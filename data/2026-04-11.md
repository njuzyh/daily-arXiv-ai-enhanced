...
### [3] [LogAct: Enabling Agentic Reliability via Shared Logs](https://arxiv.org/abs/2604.07988)
...
### [4] [LegoDiffusion: Micro-Serving Text-to-Image Diffusion Workflows](https://arxiv.org/abs/2604.08123)
...
### [6] [Scheduling Coflows in Multi-Core OCS Networks with Performance Guarantee](https://arxiv.org/abs/2604.08242)
...
### [8] [City-Scale Visibility Graph Analysis via GPU-Accelerated HyperBall](https://arxiv.org/abs/2604.08374)
...
### [9] [NL-CPS: Reinforcement Learning-Based Kubernetes Control Plane Placement in Multi-Region Clusters](https://arxiv.org/abs/2604.08434)
...
### [10] [Taming GPU Underutilization via Static Partitioning and Fine-grained CPU Offloading](https://arxiv.org/abs/2604.08451)
...
### [11] [Position Paper: From Edge AI to Adaptive Edge AI](https://arxiv.org/abs/2604.07360)
...
### [12] [Self-Calibrating LLM-Based Analog Circuit Sizing with Interpretable Design Equations](https://arxiv.org/abs/2604.07387)
...
### [13] [SHIELD: A Segmented Hierarchical Memory Architecture for Energy-Efficient LLM Inference on Edge NPUs](https://arxiv.org/abs/2604.07396)
...
### [14] [FILCO: Flexible Composing Architecture with Real-Time Reconfigurability for DNN Acceleration](https://arxiv.org/abs/2604.07523)
...
### [15] [From LLM to Silicon: RL-Driven ASIC Architecture Exploration for On-Device AI Inference](https://arxiv.org/abs/2604.07526)
...
### [16] [Trilinear Compute-in-Memory Architecture for Energy-Efficient Transformer Acceleration](https://arxiv.org/abs/2604.07628)
...
### [17] [A Full-Stack Performance Evaluation Infrastructure for 3D-DRAM-based LLM Accelerators](https://arxiv.org/abs/2604.08044)
...
### [18] [IPEK: Intelligent Priority-Aware Event-Based Trust with Asymmetric Knowledge for Resilient Vehicular Ad-Hoc Networks](https://arxiv.org/abs/2604.07532)
...
### [19] [RL-ASL: A Dynamic Listening Optimization for TSCH Networks Using Reinforcement Learning](https://arxiv.org/abs/2604.07533)
...
### [20] [SAFE: Spatially-Aware Feedback Enhancement for Fault-Tolerant Trust Management in VANETs](https://arxiv.org/abs/2604.07552)
*İpek Abasıkeleş Turgut*
...
### [21] [LCMP: Distributed Long-Haul Cost-Aware Multi-Path Routing for Inter-Datacenter RDMA Networks](https://arxiv.org/abs/2604.07836)
...
### [22] [Design and empirical validation of a stock-Android software architecture for Wi-Fi Direct multi-group communication](https://arxiv.org/abs/2604.07889)
...
### [23] [Incentivising green video streaming through a 2-tier subscription model with carbon-aware rewards](https://arxiv.org/abs/2604.07910)
...
### [24] [Beyond Static Forecasting: Unleashing the Power of World Models for Mobile Traffic Extrapolation](https://arxiv.org/abs/2604.08199)
...
### [25] [FORSLICE: An Automated Formal Framework for Efficient PRB-Allocation towards Slicing Multiple Network Services](https://arxiv.org/abs/2604.08244)
...
### [26] [Real-Time Cross-Layer Semantic Error Correction Using Language Models and Software-Defined Radio](https://arxiv.org/abs/2604.08419)
...
### [27] [LITE: Lightweight Channel Gain Estimation with Reduced X-Haul CSI Signaling in O-RAN](https://arxiv.org/abs/2604.08458)
