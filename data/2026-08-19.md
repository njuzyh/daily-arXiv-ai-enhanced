...
### [1] [The benefits and challenges of explicit memory management in OpenMP Target GPU offloading](https://arxiv.org/abs/2608.14554)
*Igor Sfiligoi*
...
### [2] [Discovering KV Cache Eviction Policies via LLM-Guided Program Evolution](https://arxiv.org/abs/2608.14555)
...
### [3] [Orbital AI Computing: Carbon Tradeoffs Across Satellite Scale](https://arxiv.org/abs/2608.14557)
...
### [4] [Agentic Kernel Optimization: Generating State-of-the-Art GPU Kernels Without Hand-Written CUDA](https://arxiv.org/abs/2608.14560)
...
### [5] [A Biophysically-Inspired Feedback Controller for Multi-Class Cache Fairness](https://arxiv.org/abs/2608.14561)
*Matt R. Flax*
...
### [6] [The Uneasy Marriage of AI and Dependability: Integrating Taxonomy and Methods for Dependability and Accuracy Enhancement](https://arxiv.org/abs/2608.14564)
*Aad van Moorsel*
...
### [7] [Efficient Block-Layer Parallel Inference for Vision-Language-Action on Hybrid Architectures](https://arxiv.org/abs/2608.14586)
...
### [8] [Belayer: Efficient Fault Tolerance for LLM Agentic RL Training](https://arxiv.org/abs/2608.14635)
...
### [9] [Porting and Benchmarking Chapel on Emerging RISC-V Hardware: an HPC Viability Study](https://arxiv.org/abs/2608.14799)
...
### [10] [When Does Distributed AI Inference Need More Wide-Area Bandwidth? A Co-Design Evaluation of Optical, Packet, and Software Levers](https://arxiv.org/abs/2608.14967)
*Prasanna C*
...
### [11] [Collective Communication for Distributed LLM Systems: Planning, Runtime Adaptation, and Computation Coordination](https://arxiv.org/abs/2608.15118)
...
### [12] [P-PAS: Prefill-Pressure Adaptive Scheduling for Long-Context LLM Serving](https://arxiv.org/abs/2608.15171)
*Timo Sämann*
...
### [13] [LOCAL: Enabling Learning On-device Contiguously for Agent LLMs](https://arxiv.org/abs/2608.15241)
...
### [14] [FloodReasonBench: Benchmarking VLM Reasoning Segmentation for Embodied Flood Response at the Edge](https://arxiv.org/abs/2608.15410)
...
### [15] [eAVID: Asynchronous Verifiable Information Dispersal with Post-Dissemination Pruning](https://arxiv.org/abs/2608.15469)
...
### [16] [Q-First: Attention and Feed-Forward Concurrency at the Smallest Change to the Block](https://arxiv.org/abs/2608.15473)
*WenJie Fan*
...
### [17] [FlashQuant: Sparse-Dense Fusion for Memory-Efficient Outlier-Aware LLM Inference](https://arxiv.org/abs/2608.15531)
...
### [18] [DeltaLog: Deferred Materialization of Recurrent States for Linear Attention Decoding](https://arxiv.org/abs/2608.15533)
...
### [19] [When Is Shallow Enough? Adaptive Split Federated Learning with Client-Specific Sufficiency Estimation](https://arxiv.org/abs/2608.15639)
...
### [20] [Adaptive Heterogeneous Compression for Resource-Efficient Federated Knowledge Distillation](https://arxiv.org/abs/2608.15660)
...
### [21] [KV-Pipe: On the Relation Between KV Sharing and Pipeline Parallel Efficiency in LLMs](https://arxiv.org/abs/2608.15943)
...
### [22] [A Scalable Pipeline for LLM-Teacher Distillation Labeling: Work-Stealing Job Scheduling and Memory-Aware GPU Concurrency](https://arxiv.org/abs/2608.15975)
...
### [23] [FreeToken: Efficient Edge-Native MoE Serving with Bandwidth-Adaptive Execution](https://arxiv.org/abs/2608.16157)
...
### [24] [Agent-Native Telemetry: Verifiable State-Delta Evidence for Autonomous Operations](https://arxiv.org/abs/2608.16178)
*Jun He,Deying Yu*
...
### [25] [DepTGL: A Parallel Framework for Memory-based TGNN Training with Adaptive Temporal Data Dependency Management](https://arxiv.org/abs/2608.16305)
...
### [26] [DB-SpMSpV: Dual-View Blocked Sparse Matrix-Sparse Vector Multiplication for Dynamic GPU Workloads](https://arxiv.org/abs/2608.16308)
...
### [27] [MELD: A Protocol for Merging Knowledge Across Distributed Agentic Memories](https://arxiv.org/abs/2608.16357)
...
### [28] [GPU implementation of a resource-constrained virtual machine](https://arxiv.org/abs/2608.16387)
...
### [29] [Vantage: Availability-Graded Broadcast for Signature-Free BFT](https://arxiv.org/abs/2608.16504)
*Nikita Polyanskii*
...
### [30] [HAPS through the Lens of Satellites and UAVs: A Function-Level Perspective on the Emerging High Altitude Economy](https://arxiv.org/abs/2608.16828)
...
### [31] [Concurrency Response of Plain Global Loads on the NVIDIA H100](https://arxiv.org/abs/2608.15764)
...
### [32] [Beyond Binary Priorities: Multi-Tier SLA Scheduling for Large Language Model Serving](https://arxiv.org/abs/2608.16336)
...
### [33] [TRACE: Traversal and Reasoning Algebraic Computing Engine for Formal Hardware Verification](https://arxiv.org/abs/2608.16458)
...
### [34] [GoalEvolve: From Handcrafted Algorithm Priors to Goal-Driven Evolution of Physical Design Algorithms](https://arxiv.org/abs/2608.16733)
...
### [35] [Persistent Spatio-Temporal Outage Hotspot Detection for Infrastructure Resilience Planning](https://arxiv.org/abs/2608.14572)
...
### [36] [WARA: Toward Automated Wireless Optimization Research with Closed-Loop LLM Agents](https://arxiv.org/abs/2608.14573)
...
### [37] [From Reactive to Autonomous: Evolution of AI Operations in Cloud Network Infrastructure](https://arxiv.org/abs/2608.14574)
*Arun Malik*
...
### [38] [HW-Router: Hardware-Aware Routing for Scalable Multi-LLM Serving](https://arxiv.org/abs/2608.14575)
...
### [39] [CoMeT-Net: Consensus Memory Template Network for Real-time Traffic Anomaly Detection](https://arxiv.org/abs/2608.14576)
...
### [40] [Enabling Telecommunication Relay Service Research with ACE Omni Platform](https://arxiv.org/abs/2608.14582)
...
### [41] [Evaluating the impact of adversarial traffic patterns on vanet communication using veins simulation](https://arxiv.org/abs/2608.14583)
*Henry Agyapong*
...
### [42] [Comparing UPF Dataplane I/O Modes in a Cloud-Native 5G Core: AF_PACKET, AF_XDP, CNDP, and DPDK on SD-Core BESS-UPF](https://arxiv.org/abs/2608.14589)
...
### [43] [Low-Latency Spatial-Provenance Recovery Methods for Privacy-Constrained Vehicular Networks](https://arxiv.org/abs/2608.14592)
...
### [44] [BC-DIR: Bandit-Controlled Deadline-Aware Incremental Redundancy for QUIC in V2X Networks](https://arxiv.org/abs/2608.14593)
...
### [45] [Cyberspace Search Intentions as Leading Indicators for Proactive Traffic Hotspot Detection](https://arxiv.org/abs/2608.14595)
...
### [46] [Real-Time Patient Monitoring with Heterogeneous Systems Using DDS-Based Communication](https://arxiv.org/abs/2608.14597)
...
### [47] [Intelligent Base Station Deployment in Urban Wireless Networks: A Geographic Data-Informed Digital Twin Approach](https://arxiv.org/abs/2608.14599)
...
### [48] [Demo: Real-time Generative Multicasting with On-Device Intent-aware Semantic Decomposition](https://arxiv.org/abs/2608.14600)
...
### [49] [OneBarrier: What a Network Must Provide for Transparent Fault Tolerance to Be Free](https://arxiv.org/abs/2608.14601)
*Bojie Li*
...
### [50] [Extend the Safety Horizon for Intelligent Transportation Systems through Semantic-Aware Cooperative Perception](https://arxiv.org/abs/2608.14603)
...
### [51] [Deep Reinforcement Learning for 6G AI-RAN: A Comprehensive Survey](https://arxiv.org/abs/2608.14877)
...
### [52] [Agentic AI-Enabled Solar-Powered High-Altitude Platforms for Sustainable SAGINs](https://arxiv.org/abs/2608.15087)
...
### [53] [ISAC in 3GPP: Evolution Toward 6G](https://arxiv.org/abs/2608.15283)
*Neeraj Varshney*
...
### [54] [Exploring the Suitability of QUIC for the Internet of Things](https://arxiv.org/abs/2608.15366)
...
### [55] [Adaptive Bridge: A Proxy-Based Decoupling Layer for Mitigating DDS Backpressure in ROS 2](https://arxiv.org/abs/2608.15380)
*Kaushalraj Puwar*
...
### [56] [Maintaining IoT Device Identification under Concept Drift via Budget-Aware Traffic Labeling](https://arxiv.org/abs/2608.15465)
...
### [57] [WiFiSpectralJam: A Large-Scale Open Wi-Fi Spectral Scan Dataset with Controlled RF Jamming](https://arxiv.org/abs/2608.15728)
...
### [58] [Scaling the Lightning Network with Practical Set Reconciliation](https://arxiv.org/abs/2608.15921)
...
### [59] [SbDN: Source-based TSN-Grade Deterministic Networking using Commodity Switches](https://arxiv.org/abs/2608.16199)
...
### [60] [Towards the Interplanetary Internet: An IoT Perspective](https://arxiv.org/abs/2608.16330)
...
### [61] [OVS Meets PQ-TLS: Exploring Post-Quantum TLS for SDN's Southbound API](https://arxiv.org/abs/2608.16582)
...
### [62] [Expanding Access, Exposing Risk: A Short Study of Exposed Starlink Hosts](https://arxiv.org/abs/2608.16839)
