...
### [1] [A Parallel and Distributed Rust Library for Core Decomposition on Large Graphs](https://arxiv.org/abs/2512.00233)
...
### [2] [Heimdall++: Optimizing GPU Utilization and Pipeline Parallelism for Efficient Single-Pulse Detection](https://arxiv.org/abs/2512.00398)
...
### [3] [IslandRun: Privacy-Aware Multi-Objective Orchestration for Distributed AI Inference](https://arxiv.org/abs/2512.00595)
...
### [4] [Steady and Energy-Efficient Multi-Hop Clustering for Flying Ad-Hoc Networks (FANETs)](https://arxiv.org/abs/2512.00623)
...
### [5] [FlexiWalker: Extensible GPU Framework for Efficient Dynamic Random Walks with Runtime Adaptation](https://arxiv.org/abs/2512.00705)
...
### [6] [SIMPLE: Disaggregating Sampling from GPU Inference into a Decision Plane for Faster Distributed LLM Serving](https://arxiv.org/abs/2512.00719)
...
### [7] [Elastic Mixture of Rank-Wise Experts for Knowledge Reuse in Federated Fine-Tuning](https://arxiv.org/abs/2512.00902)
...
### [8] [Joint Partitioning and Placement of Foundation Models for Real-Time Edge AI](https://arxiv.org/abs/2512.01039)
...
### [9] [Tangram: Accelerating Serverless LLM Loading through GPU Memory Reuse and Affinity](https://arxiv.org/abs/2512.01357)
...
### [10] [Delta Sum Learning: an approach for fast and global convergence in Gossip Learning](https://arxiv.org/abs/2512.01549)
...
### [11] [StarDist: A Code Generator for Distributed Graph Algorithms](https://arxiv.org/abs/2512.01646)
...
### [12] [Trace-based, time-resolved analysis of MPI application performance using standard metrics](https://arxiv.org/abs/2512.01764)
*Kingshuk Haldar*
...
### [13] [Trust or Bust: A Survey of Threats in Decentralized Wireless Networks](https://arxiv.org/abs/2512.00023)
...
### [14] [Multi-Server FL with Overlapping Clients: A Latency-Aware Relay Framework](https://arxiv.org/abs/2512.00025)
...
### [15] [An optimization framework for task allocation in the edge/hub/cloud paradigm](https://arxiv.org/abs/2512.00029)
...
### [16] [Refined Bayesian Optimization for Efficient Beam Alignment in Intelligent Indoor Wireless Environments](https://arxiv.org/abs/2512.00036)
...
### [17] [LM4Opt-RA: A Multi-Candidate LLM Framework with Structured Ranking for Automating Network Resource Allocation](https://arxiv.org/abs/2512.00039)
...
### [18] [Constrained Network Slice Assignment via Large Language Models](https://arxiv.org/abs/2512.00040)
...
### [19] [Mesh Augmentation of LoRaWAN-based IoT Networks](https://arxiv.org/abs/2512.00161)
...
### [20] [On the Prediction of Wi-Fi Performance through Deep Learning](https://arxiv.org/abs/2512.00211)
...
### [21] [Analysis of the operation of a TSN switch and other devices using executable QR codes](https://arxiv.org/abs/2512.00221)
...
### [22] [Design and Evaluation of a Multi-Agent Perception System for Autonomous Flying Networks](https://arxiv.org/abs/2512.00259)
...
### [23] [Smart-TCP: An Agentic AI-based Autonomous and Adaptive TCP Protocol](https://arxiv.org/abs/2512.00491)
...
### [24] [Improving Channel Estimation Through Gold Sequences](https://arxiv.org/abs/2512.00509)
...
### [25] [Goal-Oriented Multi-Agent Semantic Networking: Unifying Intents, Semantics, and Intelligence](https://arxiv.org/abs/2512.01035)
...
### [26] [Internet of Intelligent Reflecting Surfaces (IoIRS)](https://arxiv.org/abs/2512.01083)
...
### [27] [Physical-Layer Analysis of LoRa Robustness in the Presence of Narrowband Interference](https://arxiv.org/abs/2512.01088)
...
### [28] [Modeling and Simulation of Data Protection Systems for Business Continuity and Disaster Recovery](https://arxiv.org/abs/2512.01477)
...
### [29] [Velocity-Adaptive Access Scheme for Semantic-Aware Vehicular Networks: Joint Fairness and AoI Optimization](https://arxiv.org/abs/2512.01571)
...
### [30] [HERMES: Heterogeneous Application-Enabled Routing Middleware for Edge-IoT Systems](https://arxiv.org/abs/2512.01824)
...
### [31] [Delay Tolerant Networking to Extend Connectivity in Rural Areas Using Public Transport Systems: Design And Analysis](https://arxiv.org/abs/2512.01829)
...
### [32] [VeriPy - A New Python-Based Approach for SDR Pipelined/Unrolled Hardware Accelerator Generation](https://arxiv.org/abs/2512.00006)
...
### [33] [Architect in the Loop Agentic Hardware Design and Verification](https://arxiv.org/abs/2512.00016)
*Mubarek Mohammed*
...
### [34] [Hardware-Aware DNN Compression for Homogeneous Edge Devices](https://arxiv.org/abs/2512.00017)
...
### [35] [Large Language Model for Verilog Code Generation: Literature Review and the Road Ahead](https://arxiv.org/abs/2512.00020)
...
### [36] [ML-PCM : Machine Learning Technique for Write Optimization in Phase Change Memory (PCM)](https://arxiv.org/abs/2512.00026)
...
### [37] [Analysis of Single Event Induced Bit Faults in a Deep Neural Network Accelerator Pipeline](https://arxiv.org/abs/2512.00028)
...
### [38] [Hardware-Aware Neural Network Compilation with Learned Optimization: A RISC-V Accelerator Approach](https://arxiv.org/abs/2512.00031)
...
### [39] [Decoupled Control Flow and Data Access in RISC-V GPGPUs](https://arxiv.org/abs/2512.00032)
...
### [40] [Critical Path Aware Timing-Driven Global Placement for Large-Scale Heterogeneous FPGAs](https://arxiv.org/abs/2512.00038)
...
### [41] [SetupKit: Efficient Multi-Corner Setup/Hold Time Characterization Using Bias-Enhanced Interpolation and Active Learning](https://arxiv.org/abs/2512.00044)
...
### [42] [Assessing Large Language Models in Generating RTL Design Specifications](https://arxiv.org/abs/2512.00045)
...
### [43] [A Configurable Mixed-Precision Fused Dot Product Unit for GPGPU Tensor Computation](https://arxiv.org/abs/2512.00053)
...
### [44] [KAN-SAs: Efficient Acceleration of Kolmogorov-Arnold Networks on Systolic Arrays](https://arxiv.org/abs/2512.00055)
...
### [45] [LLaMCAT: Optimizing Large Language Model Inference with Cache Arbitration and Throttling](https://arxiv.org/abs/2512.00083)
...
### [46] [SafeCiM: Investigating Resilience of Hybrid Floating-Point Compute-in-Memory Deep Learning Accelerators](https://arxiv.org/abs/2512.00059)
...
### [47] [A CNN-Based Technique to Assist Layout-to-Generator Conversion for Analog Circuits](https://arxiv.org/abs/2512.00070)
...
### [48] [InF-ATPG: Intelligent FFR-Driven ATPG with Advanced Circuit Representation Guided Reinforcement Learning](https://arxiv.org/abs/2512.00079)
...
### [49] [Modeling and Simulation Frameworks for Processing-in-Memory Architectures](https://arxiv.org/abs/2512.00096)
...
### [50] [An Analytical and Empirical Investigation of Tag Partitioning for Energy-Efficient Reliable Cache](https://arxiv.org/abs/2512.00112)
...
### [51] [From RISC-V Cores to Neuromorphic Arrays: A Tutorial on Building Scalable Digital Neuromorphic Processors](https://arxiv.org/abs/2512.00113)
...
### [52] [Ternary-Input Binary-Weight CNN Accelerator Design for Miniature Object Classification System with Query-Driven Spatial DVS](https://arxiv.org/abs/2512.00138)
...
### [53] [Variable Point: A Number Format for Area- and Energy-Efficient Multiplication of High-Dynamic-Range Numbers](https://arxiv.org/abs/2512.00186)
...
### [54] [Efficient Kernel Mapping and Comprehensive System Evaluation of LLM Acceleration on a CGLA](https://arxiv.org/abs/2512.00335)
...
### [55] [A Novel 8T SRAM-Based In-Memory Computing Architecture for MAC-Derived Logical Functions](https://arxiv.org/abs/2512.00441)
...
### [56] [Leveraging Recurrent Patterns in Graph Accelerators](https://arxiv.org/abs/2512.01193)
...
### [57] [hls4ml: A Flexible, Open-Source Platform for Deep Learning Acceleration on Reconfigurable Hardware](https://arxiv.org/abs/2512.01463)
...
### [58] [RoMe: Row Granularity Access Memory System for Large Language Models](https://arxiv.org/abs/2512.01541)
...
### [59] [A Systematic Characterization of LLM Inference on GPUs](https://arxiv.org/abs/2512.01644)
