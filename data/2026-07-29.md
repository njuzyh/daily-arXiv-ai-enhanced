...
### [1] [SpecBox: Speculative Sandbox Scheduling for Efficient LLM Agent Serving](https://arxiv.org/abs/2607.23933)
...
### [2] [TRUAV: Distributed Multi-Agent Reinforcement Learning for Trajectory Planning and Routing Enhancement in UAV-Aided IoT-Enabled VANETs](https://arxiv.org/abs/2607.23734)
...
### [3] [Denial of Deadline: Network-Driven Accuracy Collapse in Distributed Inference Pipelines](https://arxiv.org/abs/2607.24692)
...
### [4] [GNN-based Multi-Agent Control of Traffic Shockwaves in Sparse Vehicular Ad-hoc Networks](https://arxiv.org/abs/2607.23792)
...
### [5] [Reducing Instruction-Fetch Energy in RISC-V for Embedded AI Processing via Dynamic and Static Loop Caching](https://arxiv.org/abs/2607.22792)
...
### [6] [Characterizing Warp Divergence from Pascal to Blackwell](https://arxiv.org/abs/2607.23402)
*Alpin Dale*
