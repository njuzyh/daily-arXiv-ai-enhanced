...
### [1] [ARBITER: Guarded Agentic Control for SLO-Oriented Kubernetes Remediation](https://arxiv.org/abs/2607.19182)
...
### [2] [Keeping the Cache Warm Pays: Keepalive Economics for Agentic Workloads](https://arxiv.org/abs/2607.19214)
*Maxim Khailo*
...
### [3] [Accelerating Heterogeneous Agent Collaboration in Dynamic Edge Networks](https://arxiv.org/abs/2607.18244)
...
### [4] [HACO: Hedged Agent Computing for Reliable LLM Systems](https://arxiv.org/abs/2607.19215)
