...
### [7] [Performance Guarantees for Data Freshness in Resource-Constrained Adversarial IoT Systems](https://arxiv.org/abs/2512.18155)
...
### [8] [TCP BBR Performance over Wi-Fi~6: AQM Impacts and Cross-Layer Insights](https://arxiv.org/abs/2512.18259)
...
### [9] [Wireless Copilot: An AI-Powered Partner for Navigating Next-Generation Wireless Complexity](https://arxiv.org/abs/2512.18582)
...
### [10] [How Many Pinching Antennas Are Enough?](https://arxiv.org/abs/2512.18761)
...
### [11] [QoS-Aware Load Balancing in the Computing Continuum via Multi-Player Bandits](https://arxiv.org/abs/2512.18915)
...
### [12] [Optimal 3D Directional WPT Charging via UAV for 3D Wireless Rechargeable Sensor Networks](https://arxiv.org/abs/2512.19075)
...
### [13] [BEVCooper: Accurate and Communication-Efficient Bird's-Eye-View Perception in Vehicular Networks](https://arxiv.org/abs/2512.19082)
...
### [14] [On Network-Aware Semantic Communication and Edge-Cloud Collaborative Intelligence Systems](https://arxiv.org/abs/2512.19563)
...
### [15] [CORE: Compensable Reward as a Catalyst for Improving Offline RL in Wireless Networks](https://arxiv.org/abs/2512.19671)
...
### [16] [Efficient Multi-Adapter LLM Serving via Cross-Model KV-Cache Reuse with Activated LoRA](https://arxiv.org/abs/2512.17910)
...
### [17] [Byzantine Fault-Tolerant Multi-Agent System for Healthcare: A Gossip Protocol Approach to Secure Medical Message Propagation](https://arxiv.org/abs/2512.17913)
*Nihir Chadderwala*
...
### [18] [QAISim: A Toolkit for Modeling and Simulation of AI in Quantum Cloud Computing Environments](https://arxiv.org/abs/2512.17918)
...
### [19] [Accelerated Digital Twin Learning for Edge AI: A Comparison of FPGA and Mobile GPU](https://arxiv.org/abs/2512.17941)
...
### [20] [Fast Online Digital Twinning on FPGA for Mission Critical Applications](https://arxiv.org/abs/2512.17942)
...
### [21] [ACE-Sync: An Adaptive Cloud-Edge Synchronization Framework for Communication-Efficient Large-Scale Distributed Model Training](https://arxiv.org/abs/2512.18127)
...
### [22] [TraCT: Disaggregated LLM Serving with CXL Shared Memory KV Cache at Rack-Scale](https://arxiv.org/abs/2512.18194)
...
### [23] [Faster Vertex Cover Algorithms on GPUs with Component-Aware Parallel Branching](https://arxiv.org/abs/2512.18334)
...
### [24] [Remoe: Towards Efficient and Low-Cost MoE Inference in Serverless Computing](https://arxiv.org/abs/2512.18674)
...
### [25] [A Real-Time Digital Twin for Adaptive Scheduling](https://arxiv.org/abs/2512.18894)
...
### [26] [Evidential Trust-Aware Model Personalization in Decentralized Federated Learning for Wearable IoT](https://arxiv.org/abs/2512.19131)
...
### [27] [L4: Low-Latency and Load-Balanced LLM Serving via Length-Aware Scheduling](https://arxiv.org/abs/2512.19179)
...
### [28] [Faster Distributed Inference-Only Recommender Systems via Bounded Lag Synchronous Collectives](https://arxiv.org/abs/2512.19342)
