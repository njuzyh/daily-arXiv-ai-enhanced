...
### [9] [SAT-MapIt: A SAT-based Modulo Scheduling Mapper for Coarse Grain Reconfigurable Architectures](https://arxiv.org/abs/2512.02875)
...
### [10] [Mapping code on Coarse Grained Reconfigurable Arrays using a SAT solver](https://arxiv.org/abs/2512.02884)
...
### [11] [Intrusion Detection on Resource-Constrained IoT Devices with Hardware-Aware ML and DL](https://arxiv.org/abs/2512.02272)
...
### [12] [The xApp Store: A Framework for xApp Onboarding and Deployment in O-RAN](https://arxiv.org/abs/2512.02297)
...
### [13] [Coalitional Game Framework for Multicast in Wireless Networks](https://arxiv.org/abs/2512.02347)
...
### [14] [Diffusion-Model-enhanced Multiobjective Optimization for Improving Forest Monitoring Efficiency in UAV-enabled Internet-of-Things](https://arxiv.org/abs/2512.02370)
...
### [15] [ProtO-RU: An O-RAN Split-7.2 Radio Unit using SDRs](https://arxiv.org/abs/2512.02398)
...
### [16] [Widening the Coverage of Reference Broadcast Infrastructure Synchronization in Wi-Fi Networks](https://arxiv.org/abs/2512.02454)
...
### [17] [Wi-Fi Rate Adaptation for Moving Equipment in Industrial Environments](https://arxiv.org/abs/2512.02455)
...
### [18] [Rural Connectivity Inequalities in Finland and Sweden: Evidence, Measures, and Policy Reflections](https://arxiv.org/abs/2512.02649)
...
### [19] [ISAC-Powered Distributed Matching and Resource Allocation in Multi-band NTN](https://arxiv.org/abs/2512.02843)
...
### [20] [Network Self-Configuration based on Fine-Tuned Small Language Models](https://arxiv.org/abs/2512.02861)
